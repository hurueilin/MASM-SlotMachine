...
del slotmachine.lst	REM slotmachine可以替換成.asm檔的檔名
del slotmachine.obj
del slotmachine.ilk
del slotmachine.pdb
del slotmachine.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:slotmachine.exe slotmachine.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
